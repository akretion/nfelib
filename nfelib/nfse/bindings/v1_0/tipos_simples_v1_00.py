...
class TsideDedRed(Enum):
    ...
    Materiais; 3 – Produção externa; 4 – Reembolso de despesas; 5 – Repasse
    consorciado; 6 – Repasse plano de saúde; 7 – Serviços;
...
class TssituacaoCadastroContribuinteCnc(Enum):
    """Situação do cadastro do contribuinte no CNC:
...
class TssituacaoEmissaoNfse(Enum):
...
class TstipoIndTotTrib(Enum):
    ...
    Possui valor fixo igual a zero (indTotTrib=0). Não informar nenhum valor estimado para os Tributos (Decreto 8.264/2014).
    0 - Não;
    """
