...
class TprotNfe(CommonMixin):
    ...
    infProt: TprotNfe.InfProt = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/nfe",
        }
...
class TretCancNfeV200107:
    ...
    infCanc: TretCancNfeV200107.InfCanc = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/nfe",
        }
    ...
    versao: TverCancNfeV200107 = field(
        metadata={
            "type": "Attribute",
        }
    )
