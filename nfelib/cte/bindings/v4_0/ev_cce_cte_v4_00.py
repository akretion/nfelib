...
class EvCceCte:
    ...
    descEvento: None | EvCceCteDescEvento = field(
        default=None,
        metadata={
            "type": "Element",
    ...
    xCondUso: None | EvCceCteXCondUso = field(
        default=None,
        metadata={
            "type": "Element",
            "white_space": "preserve",
    ...
    class InfCorrecao:
        ...
        nroItemAlterado: None | str = field(
            default=None,
            metadata={
                "type": "Element",
                "white_space": "preserve",
