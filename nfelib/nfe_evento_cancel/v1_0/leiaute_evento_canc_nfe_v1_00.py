...
from nfelib.nfe_evento_cancel.v1_0.xmldsig_core_schema_v1_01 import Signature
...
class Tevento:
    ...
    class InfEvento:
        ...
        :ivar det_evento: Schema XML de validação do evento do
        ...
        class DetEvento:
            ...
            :ivar n_prot: Número do Protocolo de Status da NF-e. 1
