...
class Ferrov:
    ...
    tpTraf: None | FerrovTpTraf = field(
        default=None,
        metadata={
            "type": "Element",
            "white_space": "preserve",
    ...
    trafMut: None | Ferrov.TrafMut = field(
        default=None,
        metadata={
            "type": "Element",
        },
    )
    fluxo: None | str = field(
        default=None,
        metadata={
            "type": "Element",
            "min_length": 1,
    ...
    class TrafMut:
        ...
        respFat: None | TrafMutRespFat = field(
            default=None,
            metadata={
                "type": "Element",
                "white_space": "preserve",
        ...
        ferrEmi: None | TrafMutFerrEmi = field(
            default=None,
            metadata={
                "type": "Element",
                "white_space": "preserve",
        ...
        chCTeFerroOrigem: None | str = field(
            default=None,
            metadata={
                "type": "Element",
                "max_length": 44,
        ...
        class FerroEnv:
            ...
            enderFerro: None | TenderFer = field(
                default=None,
                metadata={
                    "type": "Element",
                },
