...
#   ('-f', '')
#   ('-o', '/tmp/nfelib-master/nfelib/v4_00/retInutNFe.py')
#
# Command line arguments:
#   /tmp/nfelib-master/schemas/nfe/v4_00/retInutNFe_v4.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/nfelib-master/nfelib/v4_00/retInutNFe.py" /tmp/nfelib-master/schemas/nfe/v4_00/retInutNFe_v4.00.xsd
#
