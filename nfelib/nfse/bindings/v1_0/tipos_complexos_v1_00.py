...
class TccomExterior:
    ...
    mdPrestacao: TsmodoPrestacao = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
    )
    vincPrest: TsvincPrest = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
    ...
    mecAFComexP: TsmecAfcomExPrest = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
    )
    mecAFComexT: TsmecAfcomExToma = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
    )
    movTempBens: TsmovTempBens = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
...
class Tcemitente:
    ...
    enderNac: TcenderecoEmitente = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
...
class TctribMunicipal:
    ...
    tpRetISSQN: TstipoRetIssqn = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
...
class TcdocDedRed:
    ...
    dtEmiDoc: XmlDate = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
    )
    vDedutivelRedutivel: str = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
            "white_space": "preserve",
...
class TcinfNfse:
    ...
    ambGer: TsambGeradorNfse = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
    )
    tpEmis: TstipoEmissao = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
    )
    procEmi: TsprocEmissao = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
