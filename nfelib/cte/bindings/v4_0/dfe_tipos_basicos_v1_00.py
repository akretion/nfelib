...
@dataclass
class TajusteCompet(CommonMixin):
    """
...
@dataclass
class TestornoCred(CommonMixin):
    """
...
class TibscbsmonoTot(CommonMixin):
    ...
    @dataclass
    class GEstornoCred(CommonMixin):
        """
...
@dataclass
class TcredPresOper(CommonMixin):
    """
