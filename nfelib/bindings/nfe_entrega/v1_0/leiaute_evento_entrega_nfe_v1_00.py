...
from nfelib.bindings.nfe_entrega.v1_0.e110130_v1_00 import DetEvento
from nfelib.bindings.nfe_entrega.v1_0.tipos_basico_v1_03 import (
    Tamb,
    TcorgaoIbge,
)
from nfelib.bindings.nfe_entrega.v1_0.xmldsig_core_schema_v1_01 import Signature
...
class Tevento:
    ...
    class InfEvento:
        ...
        det_evento: Optional[DetEvento] = field(
            default=None,
            metadata={
                "name": "detEvento",
                "type": "Element",
