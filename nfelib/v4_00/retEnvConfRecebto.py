...
#   ('-f', '')
#   ('-o', '/tmp/nfelib/nfelib/v4_00/retEnvConfRecebto.py')
#
# Command line arguments:
#   /tmp/generated/schemas/nfe/v4_00/retEnvConfRecebto_v1.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/nfelib/nfelib/v4_00/retEnvConfRecebto.py" /tmp/generated/schemas/nfe/v4_00/retEnvConfRecebto_v1.00.xsd
#
