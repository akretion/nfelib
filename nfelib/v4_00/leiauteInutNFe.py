...
#
# Generated Sat Sep 14 03:47:57 2019 by generateDS.py version 2.33.3.
...
#   ('--member-specs', 'list')
#   ('-f', '')
#   ('-o', '/tmp/nfelib/nfelib/v4_00/leiauteInutNFe.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/rvalyi/DEV/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" --member-specs="list" -f -o "/tmp/nfelib/nfelib/v4_00/leiauteInutNFe.py" -
#
...
class TInutNFe(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, versao=None, infInut=None, Signature=None, **kwargs_):
    ...
    def validate_TVerInutNFe(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TVerInutNFe_patterns_, ))
...
class TProcInutNFe(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, versao=None, inutNFe=None, retInutNFe=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.versao = _cast(None, versao)
...
class infInutType(GeneratedsSuper):
    ...
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('Id', 'xs:string', 0, 0, {'use': 'required'}),
    ...
    subclass = None
    superclass = None
    def __init__(self, Id=None, tpAmb=None, xServ=None, cUF=None, ano=None, CNPJ=None, mod=None, serie=None, nNFIni=None, nNFFin=None, xJust=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
    ...
    def validate_TAmb(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TAmb' % {"value" : encode_str_2_3(value)} )
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on xServType' % {"value" : encode_str_2_3(value)} )
            if not self.gds_validate_simple_patterns(
                    self.validate_xServType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_xServType_patterns_, ))
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TCodUfIBGE' % {"value" : encode_str_2_3(value)} )
    def validate_Tano(self, value):
        # Validate type Tano, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_Tano_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_Tano_patterns_, ))
    validate_Tano_patterns_ = [['^([0-9]{2})$']]
    def validate_TCnpj(self, value):
        # Validate type TCnpj, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TCnpj' % {"value" : encode_str_2_3(value)} )
            if not self.gds_validate_simple_patterns(
                    self.validate_TCnpj_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TCnpj_patterns_, ))
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TMod' % {"value" : encode_str_2_3(value)} )
    def validate_TSerie(self, value):
        # Validate type TSerie, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_TSerie_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TSerie_patterns_, ))
    ...
    def validate_TNF(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TNF_patterns_, ))
    ...
    def validate_TJust(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TJust_patterns_, ))
...
class infInutType1(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Id=None, tpAmb=None, verAplic=None, cStat=None, xMotivo=None, cUF=None, ano=None, CNPJ=None, mod=None, serie=None, nNFIni=None, nNFFin=None, dhRecbto=None, nProt=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.Id = _cast(None, Id)
    ...
    def validate_TVerAplic(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TVerAplic_patterns_, ))
    validate_TVerAplic_patterns_ = [['^([!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1})$']]
    def validate_TStat(self, value):
        # Validate type TStat, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 3:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TStat' % {"value" : encode_str_2_3(value)} )
            if not self.gds_validate_simple_patterns(
                    self.validate_TStat_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TStat_patterns_, ))
    ...
    def validate_TMotivo(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TMotivo_patterns_, ))
    ...
    def validate_TDateTimeUTC(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TDateTimeUTC_patterns_, ))
    ...
    def validate_TProt(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 15:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TProt' % {"value" : encode_str_2_3(value)} )
            if not self.gds_validate_simple_patterns(
                    self.validate_TProt_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TProt_patterns_, ))
...
class ReferenceType(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('Id', 'ID', 0, 1, {'use': 'optional'}),
        MemberSpec_('URI', 'anyURI', 0, 0, {'use': 'required'}),
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='ds:', name_='ReferenceType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (quote_attrib(self.Id), ))
        if 'URI' not in already_processed:
...
class TransformType(GeneratedsSuper):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TTransformURI' % {"value" : encode_str_2_3(value)} )
    def hasContent_(self):
        if (
            self.XPath
        ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='ds:', name_='TransformType'):
        if 'Algorithm' not in already_processed:
