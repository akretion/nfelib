...
class TtpNfcredito(Enum):
    ...
    presumido de IBS sobre o saldo devedor na ZFM (art.
...
class TtpNfdebito(Enum):
    ...
    02=Anulação de Crédito por Saídas Imunes/Isentas; 03=Débitos de notas fiscais
    não processadas na apuração; 04=Multa e juros; 05=Transferência de crédito de
    sucessão); 06=Pagamento antecipado; 07=Perda em estoque.
    """
...
class Tnfe(CommonMixin):
    ...
    class InfNfe(CommonMixin):
        ...
        class Ide(CommonMixin):
            ...
            :ivar tpNFDebito: Tipo de Nota de Débito: 01=Transferência
                de créditos para Cooperativas; 02=Anulação de Crédito
                por Saídas Imunes/Isentas; 03=Débitos de notas fiscais
                não processadas na apuração; 04=Multa e juros;
