...
class TpagamentoRtc:
    ...
    :ivar tpMeioPgto: Meio de pagamento: 01-Boleto 02-Pix QRCode
        dinâmico 03-Pix automático 04-Pix chave ou QRCode estático
        05-TED 06-TEF / booktransfer
    ...
    tpMeioPgto: Optional[TmeioPgto] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/cte",
