...
class Tevento(CommonMixin):
    ...
    class InfEvento(CommonMixin):
        ...
        :ivar chNF3e: Chave de Acesso da NF-3e vinculada ao evento
...
class TretEvento(CommonMixin):
    ...
    class InfEvento(CommonMixin):
        ...
        :ivar chNF3e: Chave de Acesso NF-3e vinculada
...
class TprocEvento(CommonMixin):
    ...
    eventoNF3e: Optional[Tevento] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/nf3e",
    ...
    retEventoNF3e: Optional[TretEvento] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/nf3e",
