"""This file was generated by xsdata, v25.7, on 2026-09-25 18:42:51
...
class TcteOs:
    ...
    class InfCte:
        ...
        :ivar infRespTec: Informações do Responsável Técnico pela
            emissão do DF-e
        :ivar tpPagAnt: Tipo Pagamento ou Pagamento Antecipado Informar:
            1 - Pagamento Antecipado 3 - Fornecimento com pagamento
            realizado anteriormente Este campo é opcional e apenas deve
            ser informado quando pagamento que ocorre antes da prestação
            do serviço e na DFe de fornecimento associada a esses
            pagamentos, demais hipóteses de prestação de serviço sem
            antecipação não devem preencher.
        :ivar gPagAntecipado: Grupo de antecipação de pagamento
        ...
        pgtoVinc: Optional[TcteOs.InfCte.PgtoVinc] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.portalfiscal.inf.br/cte",
        ...
        tpPagAnt: Optional[TpagAnt] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.portalfiscal.inf.br/cte",
        ...
        gPagAntecipado: Optional[TcteOs.InfCte.GPagAntecipado] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.portalfiscal.inf.br/cte",
        ...
        class Ide:
            ...
            gCompraGov: Optional[TcompraGovReduzido] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "namespace": "http://www.portalfiscal.inf.br/cte",
        ...
        class Emit:
            ...
            :ivar ISUFEmit: Inscrição do emitente da Suframa Informar o
                número do Cadastro do emitente na Suframa. Campo
                obrigatório nas operações que se beneficiam de
                incentivos fiscais existentes nas áreas sob controle da
                SUFRAMA com alíquota zero da CBS referente aos arts. 451
                e 466 da LC 214/25
            """
        ...
        class GPagAntecipado:
            ...
            :ivar chCTePagAnt: Chave de acesso do CTe de antecipação de
                pagamento Referência a CTe emitido anteriormente,
                referente a pagamento antecipado
            """

            chCTePagAnt: list[str] = field(
                default_factory=list,
                metadata={
                    "type": "Element",
                    "namespace": "http://www.portalfiscal.inf.br/cte",
...
class Tcte(CommonMixin):
    ...
    class InfCte:
        ...
        pgtoVinc: Optional[Tcte.InfCte.PgtoVinc] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.portalfiscal.inf.br/cte",
        ...
        class Ide:
            ...
            :ivar xJust: Justificativa da entrada em contingência
            :ivar gCompraGov: Grupo de Compras Governamentais
            :ivar tpPagAnt: Tipo Pagamento ou Pagamento Antecipado
                Informar: 1 - Pagamento Antecipado 3 - Fornecimento com
                pagamento realizado anteriormente Este campo é opcional
                e apenas deve ser informado quando pagamento que ocorre
                antes da prestação do serviço e na DFe de fornecimento
                associada a esses pagamentos, demais hipóteses de
                prestação de serviço sem antecipação não devem
                preencher.
            :ivar gPagAntecipado: Grupo de antecipação de pagamento
                Informado para abater as parcelas de antecipação de
                pagamento, conforme Art. 10. § 4º
            ...
            procEmi: Optional[TprocEmiCte] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "namespace": "http://www.portalfiscal.inf.br/cte",
            ...
            gPagAntecipado: Optional[Tcte.InfCte.Ide.GPagAntecipado] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "namespace": "http://www.portalfiscal.inf.br/cte",
            ...
            class GPagAntecipado:
                ...
                :ivar chCTePagAnt: Chave de acesso do CTe de antecipação
                    de pagamento Referência a CTe emitido anteriormente,
                    referente a pagamento antecipado
                """
        ...
        class InfCteNorm:
            ...
            infGlobalizado: Optional[Tcte.InfCte.InfCteNorm.InfGlobalizado] = (
                field(
                    default=None,
                    metadata={
                        "type": "Element",
...
class TcteSimp:
    ...
    class InfCte:
        ...
        pgtoVinc: Optional[TcteSimp.InfCte.PgtoVinc] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.portalfiscal.inf.br/cte",
        ...
        class Ide:
            ...
            :ivar tpPagAnt: Tipo Pagamento ou Pagamento Antecipado
                Informar: 1 - Pagamento Antecipado 3 - Fornecimento com
                pagamento realizado anteriormente Este campo é opcional
                e apenas deve ser informado em caso de Antecipação de
                Pagamento e no CTe de fornecimento associada a esses
                pagamentos antecipados, demais hipóteses de prestação de
                serviço sem antecipação não devem preencher.
            :ivar gPagAntecipado: Grupo de antecipação de pagamento
                Permite informar apenas quando tpPagAnt=3 Informado para
                abater as parcelas de antecipação de pagamento, conforme
                Art. 10. § 4º
            """
            ...
            gPagAntecipado: Optional[TcteSimp.InfCte.Ide.GPagAntecipado] = (
                field(
                    default=None,
                    metadata={
                        "type": "Element",
            ...
            class GPagAntecipado:
                ...
                :ivar chDFePagAnt: Chave de acesso do DFe de antecipação
                    de pagamento (com tpPagAnt=1) Referência a CTe
                    emitido anteriormente, referente a pagamento
                    antecipado
                """

                chDFePagAnt: list[str] = field(
                    default_factory=list,
                    metadata={
                        "type": "Element",
                        "namespace": "http://www.portalfiscal.inf.br/cte",
