...
#
# Command line:
#   /usr/local/bin/generateDS.py --no-namespace-defs --member-specs="list" --use-getter-setter="none" -f -o "/tmp/nfelib/nfelib/v4_00/retConsStatServ.py" /tmp/generated/schemas/nfe/v4_00/retConsStatServ_v4.00.xsd
#
