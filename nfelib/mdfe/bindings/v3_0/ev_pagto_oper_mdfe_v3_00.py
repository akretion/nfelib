...
class InfPagIndAntecipaAdiant1(Enum):
    VALUE_1 = "1"
...
class EvPagtoOperMdfe:
    """
    Schema XML de validação do evento de pagamento da operação de
    transporte 110116.
    ...
    descEvento: None | EvPagtoOperMdfeDescEvento = field(
        default=None,
        metadata={
            "type": "Element",
    ...
    infViagens: None | EvPagtoOperMdfe.InfViagens = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    class InfPag:
        ...
        indPag: None | InfPagIndPag1 = field(
            default=None,
            metadata={
                "type": "Element",
                "white_space": "preserve",
        ...
        indAntecipaAdiant: None | InfPagIndAntecipaAdiant1 = field(
            default=None,
            metadata={
                "type": "Element",
            },
        ...
        tpAntecip: None | InfPagTpAntecip1 = field(
            default=None,
            metadata={
                "type": "Element",
            },
        )
        infBanc: None | EvPagtoOperMdfe.InfPag.InfBanc = field(
            default=None,
            metadata={
                "type": "Element",
            },
