...
SCHEMA_VERSION: str = 'XSD_PL_NFSe_1.00-Produção'
SCHEMA_PACKAGE: str = 'Pacote de esquemas XSD V1.00.02'
NOTA_TECNICA: str = '-'
PUBLISHED_AT: str = '2022-09-16'
SOURCE_URL: str = 'https://www.gov.br/nfse/pt-br/documentacao-tecnica/xsd_pl_nfse_1-00-producao.zip/@@download/file/XSD_PL_NFSe_1.00-Produção.zip'
GENERATED_AT: str = '2026-07-13T05:25:57Z'
