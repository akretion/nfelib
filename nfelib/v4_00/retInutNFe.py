...
#
# Generated Wed Sep 30 21:48:33 2020 by generateDS.py version 2.36.2.
...
#   ('-f', '')
#   ('-o', '/tmp/nfelib/nfelib/v4_00/retInutNFe.py')
#
# Command line arguments:
#   /tmp/generated/schemas/nfe/v4_00/retInutNFe_v4.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS.py --no-namespace-defs --member-specs="list" --use-getter-setter="none" -f -o "/tmp/nfelib/nfelib/v4_00/retInutNFe.py" /tmp/generated/schemas/nfe/v4_00/retInutNFe_v4.00.xsd
#
...
class TInutNFe(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('versao', 'TVerInutNFe', 0, 0, {'use': 'required'}),
        MemberSpec_('infInut', 'infInutType', 0, 0, {'name': 'infInut', 'type': 'infInutType'}, None),
        MemberSpec_('Signature', 'xs:string', 0, 0, {'name': 'Signature', 'ref': 'Signature', 'type': 'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, versao=None, infInut=None, Signature=None, gds_collector_=None, **kwargs_):
    ...
    def validate_TVerInutNFe(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TVerInutNFe_patterns_, ))
    validate_TVerInutNFe_patterns_ = [['^(4\\.00)$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TInutNFe', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TInutNFe':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TInutNFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TInutNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TInutNFe'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TInutNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.infInut is not None:
            namespaceprefix_ = self.infInut_nsprefix_ + ':' if (UseCapturedNS_ and self.infInut_nsprefix_) else ''
            self.infInut.export(outfile, level, namespaceprefix_, namespacedef_='', name_='infInut', pretty_print=pretty_print)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            ...
            self.validate_TVerInutNFe(self.versao)    # validate type TVerInutNFe
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'infInut':
            obj_ = infInutType.factory(parent_object_=self)
...
class TRetInutNFe(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('versao', 'TVerInutNFe', 0, 0, {'use': 'required'}),
        MemberSpec_('infInut', 'infInutType1', 0, 0, {'name': 'infInut', 'type': 'infInutType1'}, None),
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TRetInutNFe', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TRetInutNFe':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TRetInutNFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TRetInutNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TRetInutNFe'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.versao), input_name='versao')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TRetInutNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'infInut':
            obj_ = infInutType1.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.infInut = obj_
            obj_.original_tagname_ = 'infInut'
        elif nodeName_ == 'Signature':
...
class TProcInutNFe(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('versao', 'TVerInutNFe', 0, 0, {'use': 'required'}),
        MemberSpec_('inutNFe', 'TInutNFe', 0, 0, {'name': 'inutNFe', 'type': 'TInutNFe'}, None),
        MemberSpec_('retInutNFe', 'TRetInutNFe', 0, 0, {'name': 'retInutNFe', 'type': 'TRetInutNFe'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, versao=None, inutNFe=None, retInutNFe=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.inutNFe_nsprefix_ = None
        self.retInutNFe = retInutNFe
        self.retInutNFe_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TProcInutNFe', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TProcInutNFe':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TProcInutNFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TProcInutNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TProcInutNFe'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.versao), input_name='versao')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TProcInutNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.inutNFe is not None:
            namespaceprefix_ = self.inutNFe_nsprefix_ + ':' if (UseCapturedNS_ and self.inutNFe_nsprefix_) else ''
            self.inutNFe.export(outfile, level, namespaceprefix_, namespacedef_='', name_='inutNFe', pretty_print=pretty_print)
        if self.retInutNFe is not None:
            namespaceprefix_ = self.retInutNFe_nsprefix_ + ':' if (UseCapturedNS_ and self.retInutNFe_nsprefix_) else ''
            self.retInutNFe.export(outfile, level, namespaceprefix_, namespacedef_='', name_='retInutNFe', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'inutNFe':
            obj_ = TInutNFe.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.inutNFe = obj_
            obj_.original_tagname_ = 'inutNFe'
        elif nodeName_ == 'retInutNFe':
            obj_ = TRetInutNFe.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class infInutType(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('ano', ['Tano', 'xs:string'], 0, 0, {'name': 'ano', 'type': 'xs:string'}, None),
        ...
        MemberSpec_('nNFIni', ['TNF', 'xs:string'], 0, 0, {'name': 'nNFIni', 'type': 'xs:string'}, None),
        MemberSpec_('nNFFin', ['TNF', 'xs:string'], 0, 0, {'name': 'nNFFin', 'type': 'xs:string'}, None),
        MemberSpec_('xJust', ['TJust', 'nfe:TString'], 0, 0, {'name': 'xJust', 'type': 'xs:string'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, Id=None, tpAmb=None, xServ=None, cUF=None, ano=None, CNPJ=None, mod=None, serie=None, nNFIni=None, nNFFin=None, xJust=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.nNFIni_nsprefix_ = None
        self.nNFFin = nNFFin
        self.validate_TNF(self.nNFFin)
        self.nNFFin_nsprefix_ = None
        self.xJust = xJust
    ...
    def validate_Tano(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_Tano_patterns_, ))
                result = False
        return result
    ...
    validate_IdType_patterns_ = [['^(ID[0-9]{41})$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='infInutType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'infInutType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infInutType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infInutType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infInutType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='infInutType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ano is not None:
            namespaceprefix_ = self.ano_nsprefix_ + ':' if (UseCapturedNS_ and self.ano_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sano>%s</%sano>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ano), input_name='ano')), namespaceprefix_ , eol_))
        ...
        if self.nNFIni is not None:
            namespaceprefix_ = self.nNFIni_nsprefix_ + ':' if (UseCapturedNS_ and self.nNFIni_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snNFIni>%s</%snNFIni>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.nNFIni), input_name='nNFIni')), namespaceprefix_ , eol_))
        if self.nNFFin is not None:
            namespaceprefix_ = self.nNFFin_nsprefix_ + ':' if (UseCapturedNS_ and self.nNFFin_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snNFFin>%s</%snNFFin>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.nNFFin), input_name='nNFFin')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'tpAmb':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ano')
            value_ = self.gds_validate_string(value_, node, 'ano')
            self.ano = value_
            self.ano_nsprefix_ = child_.prefix
            # validate type Tano
            self.validate_Tano(self.ano)
        elif nodeName_ == 'CNPJ':
            value_ = child_.text
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'nNFIni')
            value_ = self.gds_validate_string(value_, node, 'nNFIni')
            self.nNFIni = value_
            self.nNFIni_nsprefix_ = child_.prefix
            # validate type TNF
            self.validate_TNF(self.nNFIni)
        elif nodeName_ == 'nNFFin':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'nNFFin')
            value_ = self.gds_validate_string(value_, node, 'nNFFin')
            self.nNFFin = value_
            self.nNFFin_nsprefix_ = child_.prefix
            # validate type TNF
            self.validate_TNF(self.nNFFin)
...
class infInutType1(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('cUF', ['TCodUfIBGE', 'xs:string'], 0, 0, {'name': 'cUF', 'type': 'xs:string'}, None),
        MemberSpec_('ano', ['Tano', 'xs:string'], 0, 1, {'minOccurs': '0', 'name': 'ano', 'type': 'xs:string'}, None),
        MemberSpec_('CNPJ', ['TCnpj', 'xs:string'], 0, 1, {'minOccurs': '0', 'name': 'CNPJ', 'type': 'xs:string'}, None),
        MemberSpec_('mod', ['TMod', 'xs:string'], 0, 1, {'minOccurs': '0', 'name': 'mod', 'type': 'xs:string'}, None),
        MemberSpec_('serie', ['TSerie', 'xs:string'], 0, 1, {'minOccurs': '0', 'name': 'serie', 'type': 'xs:string'}, None),
        MemberSpec_('nNFIni', ['TNF', 'xs:string'], 0, 1, {'minOccurs': '0', 'name': 'nNFIni', 'type': 'xs:string'}, None),
        MemberSpec_('nNFFin', ['TNF', 'xs:string'], 0, 1, {'minOccurs': '0', 'name': 'nNFFin', 'type': 'xs:string'}, None),
    ...
    subclass = None
    superclass = None
    def __init__(self, Id=None, tpAmb=None, verAplic=None, cStat=None, xMotivo=None, cUF=None, ano=None, CNPJ=None, mod=None, serie=None, nNFIni=None, nNFFin=None, dhRecbto=None, nProt=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='infInutType1', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'infInutType1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infInutType1')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='infInutType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infInutType1'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='infInutType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from retInutNFe import *\n\n')
