...
from nfelib.nfse.bindings.v1_0.xmldsig_core_schema import Signature
...
class TcvaloresNfse:
    ...
    :ivar vTotalRet: Valor total das retenções de tributos da NFS-e.
        Valor total de retenções (R$) = Σ(vRetCP + vRetIRRF+ vRetCSLL +
        ISSQN*)
    :ivar vLiq: Valor líquido da NFS-e. Valor líquido (R$) = Valor do
...
class TctribOutrosPisCofins:
    ...
    :ivar vBCPisCofins: Valor da Base de Cálculo do PIS/COFINS, relativo
        à apuração própria (R$).
    :ivar pAliqPis: Alíquota do PIS, relativa à apuração própria (%).
    :ivar pAliqCofins: Alíquota da COFINS, relativa à apuração própria
        (%).
    :ivar vPis: Valor do débito de PIS apuração própria (R$).
    :ivar vCofins: Valor do débito de COFINS apuração própria (R$).
    :ivar tpRetPisCofins: Tipo de retenção do PIS/COFINS: 0 -
...
class TcinfoTributacao:
    ...
    tribFed: Optional[TctribFederal] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
