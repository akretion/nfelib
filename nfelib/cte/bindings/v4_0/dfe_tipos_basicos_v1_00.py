"""This file was generated by xsdata, v25.7, on 2026-09-25 18:34:44
...
@dataclass
class TpagAntecipado:
    """Tipo Pagamento Antecipado Informado para abater as parcelas de antecipação
    de pagamento, conforme art.

    10 §4 Cada DFe que utilizar deverá utilizar esses tipo no grupo ide
    "
...
class TpagamentoRtc:
    ...
    CNPJBasePSP: Optional[str] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/cte",
    ...
    idTransacao: Optional[str] = field(
        default=None,
        metadata={
            "type": "Attribute",
            "required": True,
...
class TcompraGovReduzido:
    ...
    :ivar tpOperGov: Tipo da operação com ente governamental: 1 -
        Fornecimento 2 - Recebimento do Pagamento
    :ivar refDFeAnt: Chave de acesso do documento fiscal anterior. Caso
        o tipo de operação de compra governamental seja de recebimento
        do pagamento e o fornecimento tenha sido realizado antes, o DFe
        anterior referenciado deve ser da compra governamental de
        fornecimento. No momento da emissão do DFe de compra
        governamental de fornecimento, caso o pagamento já tenho
        ocorrido, deverá ser referenciado a chave de acesso do DFe de
        recebimento do pagamento. Obs: a chave de acesso deverá ser de
        um emitente com o mesmo CNPJ base
    """
    ...
    refDFeAnt: Optional[object] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/cte",
