...
#
# Generated Wed Nov 13 16:31:13 2019 by generateDS.py version 2.29.2.
# Python 3.7.4 (default, Oct  4 2019, 06:57:26)  [GCC 9.2.0]
#
# Command line options:
#   ('-o', 'nfelib/v4_00/leiauteAverb.py')
#
# Command line arguments:
#   schemas/nfe/v4_00/leiauteAverb_v1.00.xsd
#
# Command line:
#   /usr/bin/generateDS -o "nfelib/v4_00/leiauteAverb.py" schemas/nfe/v4_00/leiauteAverb_v1.00.xsd
#
...
class infEventoType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Id=None, cOrgao=None, tpAmb=None, CNPJ=None, chNFe=None, dhEvento=None, tpEvento=None, nSeqEvento=None, verEvento=None, detEvento=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.cOrgao = cOrgao
        self.validate_cOrgaoType(self.cOrgao)
        self.tpAmb = tpAmb
        self.validate_TAmb(self.tpAmb)
        self.CNPJ = CNPJ
    ...
    def get_Id(self): return self.Id
    def set_Id(self, Id): self.Id = Id
    def validate_cOrgaoType(self, value):
        # Validate type cOrgaoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['91']
            enumeration_respectee = False
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on cOrgaoType' % {"value" : value.encode("utf-8")} )
    def validate_TAmb(self, value):
        # Validate type TAmb, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
...
class detEventoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, versao=None, descEvento=None, tpAutor=None, verAplic=None, itensAverbados=None):
        self.original_tagname_ = None
        self.versao = _cast(None, versao)
        self.descEvento = descEvento
        self.validate_descEventoType(self.descEvento)
        self.tpAutor = tpAutor
        self.validate_tpAutorType(self.tpAutor)
        self.verAplic = verAplic
        self.validate_TVerAplic(self.verAplic)
        if itensAverbados is None:
            self.itensAverbados = []
        else:
            self.itensAverbados = itensAverbados
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_tpAutor(self): return self.tpAutor
    def set_tpAutor(self, tpAutor): self.tpAutor = tpAutor
    def get_verAplic(self): return self.verAplic
    def set_verAplic(self, verAplic): self.verAplic = verAplic
    def get_itensAverbados(self): return self.itensAverbados
    def set_itensAverbados(self, itensAverbados): self.itensAverbados = itensAverbados
    def add_itensAverbados(self, value): self.itensAverbados.append(value)
    def insert_itensAverbados_at(self, index, value): self.itensAverbados.insert(index, value)
    def replace_itensAverbados_at(self, index, value): self.itensAverbados[index] = value
    def get_versao(self): return self.versao
    def set_versao(self, versao): self.versao = versao
    def validate_descEventoType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['Averbação para Exportação', 'Averbacao para Exportacao']
            enumeration_respectee = False
            for enum in enumerations:
                if value == enum:
                    enumeration_respectee = True
    ...
    def validate_tpAutorType(self, value):
        # Validate type tpAutorType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['6']
            enumeration_respectee = False
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on tpAutorType' % {"value" : value.encode("utf-8")} )
    def validate_TVerAplic(self, value):
        # Validate type TVerAplic, a restriction on nfe:TString.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) > 20:
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='detEventoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.tpAutor is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpAutor>%s</tpAutor>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpAutor), input_name='tpAutor')), eol_))
        if self.verAplic is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<verAplic>%s</verAplic>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.verAplic), input_name='verAplic')), eol_))
        for itensAverbados_ in self.itensAverbados:
            itensAverbados_.export(outfile, level, namespace_, name_='itensAverbados', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'descEvento':
            ...
            self.validate_descEventoType(self.descEvento)
        elif nodeName_ == 'tpAutor':
            tpAutor_ = child_.text
            tpAutor_ = self.gds_validate_string(tpAutor_, node, 'tpAutor')
            self.tpAutor = tpAutor_
            # validate type tpAutorType
            self.validate_tpAutorType(self.tpAutor)
        elif nodeName_ == 'verAplic':
            verAplic_ = child_.text
            verAplic_ = self.gds_validate_string(verAplic_, node, 'verAplic')
            ...
            # validate type TVerAplic
            self.validate_TVerAplic(self.verAplic)
        elif nodeName_ == 'itensAverbados':
            obj_ = itensAverbadosType.factory()
            obj_.build(child_)
            self.itensAverbados.append(obj_)
            obj_.original_tagname_ = 'itensAverbados'
# end class detEventoType


class itensAverbadosType(GeneratedsSuper):
    """Informações dos itens da NF-e do evento."""
    subclass = None
    superclass = None
    def __init__(self, dhEmbarque=None, dhAverbacao=None, nDue=None, nItem=None, nItemDue=None, qItem=None, motAlteracao=None):
        self.original_tagname_ = None
        self.dhEmbarque = dhEmbarque
        self.validate_TDateTimeUTC(self.dhEmbarque)
        self.dhAverbacao = dhAverbacao
        self.validate_TDateTimeUTC(self.dhAverbacao)
        self.nDue = nDue
        self.validate_nDueType(self.nDue)
        self.nItem = nItem
        self.validate_nItemType(self.nItem)
        self.nItemDue = nItemDue
        self.validate_nItemDueType(self.nItemDue)
        self.qItem = qItem
        self.motAlteracao = motAlteracao
        self.validate_motAlteracaoType(self.motAlteracao)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, itensAverbadosType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if itensAverbadosType.subclass:
            return itensAverbadosType.subclass(*args_, **kwargs_)
        else:
            return itensAverbadosType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_dhEmbarque(self): return self.dhEmbarque
    def set_dhEmbarque(self, dhEmbarque): self.dhEmbarque = dhEmbarque
    def get_dhAverbacao(self): return self.dhAverbacao
    def set_dhAverbacao(self, dhAverbacao): self.dhAverbacao = dhAverbacao
    def get_nDue(self): return self.nDue
    def set_nDue(self, nDue): self.nDue = nDue
    def get_nItem(self): return self.nItem
    def set_nItem(self, nItem): self.nItem = nItem
    def get_nItemDue(self): return self.nItemDue
    def set_nItemDue(self, nItemDue): self.nItemDue = nItemDue
    def get_qItem(self): return self.qItem
    def set_qItem(self, qItem): self.qItem = qItem
    def get_motAlteracao(self): return self.motAlteracao
    def set_motAlteracao(self, motAlteracao): self.motAlteracao = motAlteracao
    def validate_TDateTimeUTC(self, value):
        # Validate type TDateTimeUTC, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_TDateTimeUTC_patterns_, ))
    validate_TDateTimeUTC_patterns_ = [['^(((20(([02468][048])$|^([13579][26]))-02-29))$|^(20[0-9][0-9])-((((0[1-9])$|^(1[0-2]))-((0[1-9])$|^(1\\d)$|^(2[0-8])))$|^((((0[13578])$|^(1[02]))-31)$|^(((0[1,3-9])$|^(1[0-2]))-(29$|^30)))))T(20$|^21$|^22$|^23$|^[0-1]\\d):[0-5]\\d:[0-5]\\d([\\-,\\+](0[0-9]$|^10$|^11):00$|^([\\+](12):00))$']]
    def validate_nDueType(self, value):
        # Validate type nDueType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_nDueType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nDueType_patterns_, ))
    validate_nDueType_patterns_ = [['^[0-9]{2}BR[0-9]{10}$']]
    def validate_nItemType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nItemType_patterns_, ))
    validate_nItemType_patterns_ = [['^[0-9]{1,3}$']]
    def validate_nItemDueType(self, value):
        # Validate type nItemDueType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_nItemDueType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nItemDueType_patterns_, ))
    validate_nItemDueType_patterns_ = [['^[0-9]{1,4}$']]
    def validate_motAlteracaoType(self, value):
        # Validate type motAlteracaoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['1', '2', '3']
            enumeration_respectee = False
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on motAlteracaoType' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            self.dhEmbarque is not None or
            self.dhAverbacao is not None or
            self.nDue is not None or
            self.nItem is not None or
            self.nItemDue is not None or
            self.qItem is not None or
            self.motAlteracao is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='itensAverbadosType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('itensAverbadosType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='itensAverbadosType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='itensAverbadosType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='itensAverbadosType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='itensAverbadosType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dhEmbarque is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhEmbarque>%s</dhEmbarque>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.dhEmbarque), input_name='dhEmbarque')), eol_))
        if self.dhAverbacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhAverbacao>%s</dhAverbacao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.dhAverbacao), input_name='dhAverbacao')), eol_))
        if self.nDue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nDue>%s</nDue>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nDue), input_name='nDue')), eol_))
        if self.nItem is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nItem>%s</nItem>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nItem), input_name='nItem')), eol_))
        if self.nItemDue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nItemDue>%s</nItemDue>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nItemDue), input_name='nItemDue')), eol_))
        if self.qItem is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<qItem>%s</qItem>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.qItem), input_name='qItem')), eol_))
        if self.motAlteracao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<motAlteracao>%s</motAlteracao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.motAlteracao), input_name='motAlteracao')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dhEmbarque':
            dhEmbarque_ = child_.text
            dhEmbarque_ = self.gds_validate_string(dhEmbarque_, node, 'dhEmbarque')
            self.dhEmbarque = dhEmbarque_
            # validate type TDateTimeUTC
            self.validate_TDateTimeUTC(self.dhEmbarque)
        elif nodeName_ == 'dhAverbacao':
            dhAverbacao_ = child_.text
            dhAverbacao_ = self.gds_validate_string(dhAverbacao_, node, 'dhAverbacao')
            self.dhAverbacao = dhAverbacao_
            # validate type TDateTimeUTC
            self.validate_TDateTimeUTC(self.dhAverbacao)
        elif nodeName_ == 'nDue':
            nDue_ = child_.text
            nDue_ = self.gds_validate_string(nDue_, node, 'nDue')
            self.nDue = nDue_
            # validate type nDueType
            self.validate_nDueType(self.nDue)
        elif nodeName_ == 'nItem':
            nItem_ = child_.text
            nItem_ = self.gds_validate_string(nItem_, node, 'nItem')
            self.nItem = nItem_
            # validate type nItemType
            self.validate_nItemType(self.nItem)
        elif nodeName_ == 'nItemDue':
            nItemDue_ = child_.text
            nItemDue_ = self.gds_validate_string(nItemDue_, node, 'nItemDue')
            self.nItemDue = nItemDue_
            # validate type nItemDueType
            self.validate_nItemDueType(self.nItemDue)
        elif nodeName_ == 'qItem':
            qItem_ = child_.text
            qItem_ = self.gds_validate_string(qItem_, node, 'qItem')
            self.qItem = qItem_
        elif nodeName_ == 'motAlteracao':
            motAlteracao_ = child_.text
            motAlteracao_ = self.gds_validate_string(motAlteracao_, node, 'motAlteracao')
            self.motAlteracao = motAlteracao_
            # validate type motAlteracaoType
            self.validate_motAlteracaoType(self.motAlteracao)
# end class itensAverbadosType
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from leiauteAverb import *\n\n')
        sys.stdout.write('import leiauteAverb as model_\n\n')
