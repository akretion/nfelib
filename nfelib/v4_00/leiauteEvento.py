...
#
# Generated Thu Nov 14 11:05:51 2019 by generateDS.py version 2.29.2.
# Python 3.7.4 (default, Oct  4 2019, 06:57:26)  [GCC 9.2.0]
#
# Command line options:
#   ('-o', 'nfelib/v4_00/leiauteEvento.py')
#
# Command line arguments:
#   schemas/nfe/v4_00/leiauteEvento_v1.00.xsd
#
# Command line:
#   /usr/bin/generateDS -o "nfelib/v4_00/leiauteEvento.py" schemas/nfe/v4_00/leiauteEvento_v1.00.xsd
#
...
class infEventoType1(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Id=None, tpAmb=None, verAplic=None, cOrgao=None, cStat=None, xMotivo=None, chNFe=None, tpEvento=None, xEvento=None, nSeqEvento=None, cOrgaoAutor=None, CNPJDest=None, CPFDest=None, emailDest=None, dhRegEvento=None, nProt=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.tpAmb = tpAmb
        self.validate_TAmb(self.tpAmb)
    ...
    def get_nSeqEvento(self): return self.nSeqEvento
    def set_nSeqEvento(self, nSeqEvento): self.nSeqEvento = nSeqEvento
    def get_cOrgaoAutor(self): return self.cOrgaoAutor
    def set_cOrgaoAutor(self, cOrgaoAutor): self.cOrgaoAutor = cOrgaoAutor
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='infEventoType1', fromsubclass_=False, pretty_print=True):
        ...
        if self.cOrgaoAutor is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<cOrgaoAutor>%s</cOrgaoAutor>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.cOrgaoAutor), input_name='cOrgaoAutor')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpAmb':
            ...
            cOrgaoAutor_ = child_.text
            cOrgaoAutor_ = self.gds_validate_string(cOrgaoAutor_, node, 'cOrgaoAutor')
            self.cOrgaoAutor = cOrgaoAutor_
            # validate type TCOrgaoIBGE
            self.validate_TCOrgaoIBGE(self.cOrgaoAutor)
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from leiauteEvento import *\n\n')
        sys.stdout.write('import leiauteEvento as model_\n\n')
