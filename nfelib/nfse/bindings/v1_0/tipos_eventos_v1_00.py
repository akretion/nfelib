...
class TcinfoEventoRejeicao:
    ...
    cMotivo: TscodMotivoRejeicao = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
...
class Te101103:
    ...
    cMotivo: TscodJustAnaliseFiscalCanc = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
...
class Te105104:
    ...
    cMotivo: TscodJustAnaliseFiscalCancDef = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
...
class Te105105:
    ...
    cMotivo: TscodJustAnaliseFiscalCancIndef = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
...
class Te205208:
    ...
    infAnRej: TcinfoEventoAnulacaoRejeicao = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
...
class Te305102:
    ...
    codEvento: TscodigoEventoNfse = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
...
class Te202205:
    ...
    infRej: TcinfoEventoRejeicao = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
...
class TcinfEvento:
    ...
    pedRegEvento: TcpedRegEvt = field(
        metadata={
            "type": "Element",
            "namespace": "http://www.sped.fazenda.gov.br/nfse",
        }
