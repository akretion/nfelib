...
This module is part of the generated binding package `nfelib.nfe.bindings.v4_0`.
The source XSD schema package details are tracked below.
"""

# Source schema package information (from CHANGELOG_SCHEMAS.md)
SCHEMA_VERSION: str = 'PL_010e_v1.01'
SCHEMA_PACKAGE: str = 'Pacote de Liberação 010e v1.01'
NOTA_TECNICA: str = 'NT 2025.002 v1.40, NT 2026.002 v1.0, NT 2026.003 v1.0'
PUBLISHED_AT: str = '2026-06-26'
SOURCE_URL: str = 'https://www.nfe.fazenda.gov.br/portal/exibirArquivo.aspx?conteudo=JcM57FABN1M'
