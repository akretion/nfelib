...
class EvPagtoOperMdfe:
    ...
    descEvento: EvPagtoOperMdfeDescEvento = field(
        metadata={
            "type": "Element",
    ...
    infViagens: EvPagtoOperMdfe.InfViagens = field(
        metadata={
            "type": "Element",
        }
    )
    ...
    class InfPag:
        ...
        indAntecipaAdiant: Optional[InfPagIndAntecipaAdiant1] = field(
            default=None,
            metadata={
                "type": "Element",
            },
        ...
        tpAntecip: Optional[InfPagTpAntecip1] = field(
            default=None,
            metadata={
                "type": "Element",
            },
        )
        infBanc: EvPagtoOperMdfe.InfPag.InfBanc = field(
            metadata={
                "type": "Element",
            }
        )
