"""This file was generated by xsdata, v25.7, on 2026-09-25 18:46:11
    ...
    class InfMdfe:
        ...
        class Ide:
            ...
            :ivar procEmi: Identificação do processo de emissão do
                Manifesto 0 - emissão de MDFe com aplicativo do
                contribuinte 4- emissão de MDFe por Provedor de
                Assinatura e Autorização - PAA
        ...
        class InfPaa:
            ...
            PAASignature: Optional[Tmdfe.InfMdfe.InfPaa.Paasignature] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "namespace": "http://www.portalfiscal.inf.br/mdfe",
    ...
    class InfMdfeSupl:
        ...
        qrCodMDFe: Optional[str] = field(
            ...
            metadata={
                ...
                "max_length": 1000,
                "white_space": "preserve",
                "pattern": r"((HTTPS?|https?)://.*\?chMDFe=[0-9]{6}[A-Z0-9]{12}[0-9]{26}&tpAmb=[1-2](&sign=[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1})?)",
            },
        )
