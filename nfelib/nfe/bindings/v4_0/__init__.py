...
SCHEMA_VERSION: str = 'PL_010e_v1.02'
SCHEMA_PACKAGE: str = 'Pacote de Liberação 010e v1.02'
NOTA_TECNICA: str = 'NT 2025.002 v1.40, NT 2026.002 v1.0, NT 2026.003 v1.0'
PUBLISHED_AT: str = '2026-07-10'
SOURCE_URL: str = 'https://www.nfe.fazenda.gov.br/portal/exibirArquivo.aspx?conteudo=akib2DRpJN4='
GENERATED_AT: str = '2026-07-13T05:49:30Z'
