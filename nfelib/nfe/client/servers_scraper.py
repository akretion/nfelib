...
def fetch_servers(prod_url: str, dev_url: str) -> Dict[str, Any]:
    ...
    try:
        ...
        servers_list = [
            ...
            for caption in captions if "(" in str(caption)
        ]
        ...
        for index, table in enumerate(prod_tables):
            ...
            if server == "AN":
                ...
                if "NFeDistribuicaoDFe" in actions:
                    ...
                    action_dict[constants[constant_name]] = paths[actions.index("NFeDistribuicaoDFe")]
...
def save_servers(servers: Dict[str, Any], constants: Dict[str, str], output_file: Path) -> None:
