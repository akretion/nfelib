...
class TinutCte(CommonMixin):
    ...
    :ivar infInput: Dados do Pedido de Inutilização de Numeração do
    ...
    infInput: Optional["TinutCte.InfInput"] = field(
        default=None,
        metadata={
            "type": "Element",
...
@dataclass
class TretInputCte(CommonMixin):
    """
    Tipo retorno do Pedido de Inutilização de Numeração do Conhecimento de
    Transporte eletrônico.

    :ivar infInput: Dados do Retorno do Pedido de Inutilização de
    ...
    infInput: Optional["TretInputCte.InfInput"] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/cte",
    ...
    class InfInput(CommonMixin):
        ...
        :ivar dhRecbto: Data e hora de recebimento, no formato AAAA-MM-
            DDTHH:MM:SS TZD. Deve set preenchida com data e hora da
...
@dataclass
class TprocInputCte(CommonMixin):
    """
    ...
    inputCTe: Optional[TinutCte] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/cte",
    ...
    retInputCTe: Optional[TretInputCte] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/cte",
