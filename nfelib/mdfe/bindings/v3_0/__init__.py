...
This module is part of the generated binding package `nfelib.mdfe.bindings.v3_0`.
The source XSD schema package details are tracked below.
"""

# Source schema package information (from CHANGELOG_SCHEMAS.md)
SCHEMA_VERSION: str = 'PL_MDFe_300b_NT012025_1.04'
SCHEMA_PACKAGE: str = 'Pacote de Liberação MDF-e 3.00b (zip dir PL_MDFe_300b_NT012025_1.05)'
NOTA_TECNICA: str = 'NT 2025.001'
PUBLISHED_AT: str = '2026-04-25 (zip build date)'
SOURCE_URL: str = 'https://dfe-portal.svrs.rs.gov.br/MDFE/DownloadArquivoEstatico/?sistema=MDFE&tipoArquivo=2&nomeArquivo=PL_MDFe_300b_NT012025_1.04.zip'
